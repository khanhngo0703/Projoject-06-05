...
if ($result->num_rows > 0) {
    $lst_order = $result->fetch_all(MYSQLI_ASSOC);
} else {
    $lst_order = [];
}
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="order_details_management.php?id_order=<?php echo $order['id_order']; ?>" class="btn btn-danger" id="btn-xoa">Xem don hang</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
